...
<div id="div_message"></div>
		...
		<form action="<?php echo  admin_url();?>/add-new-menu" method="post" id="user_form">
			<div class="article_ct">
				<ul class="metatags">
			    	<li>
			        	<span class="left"><b>Name* : </b></span>
			            <span class="right"><input type="text" name="name" value="" style="width:98%;" id="add-name" /></span>
			        </li>
			        <li>
			        	<span class="left"><b>Url : </b></span>
			            <span class="right"><input type="text" name="url" value="" style="width:98%;" id="add-url" /></span>
			        </li>
			        <li>
