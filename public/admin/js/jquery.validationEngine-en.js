    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "expirePass": {
                    "regex": "none",
                    "alertText": "* Your passport number must be validate ",
                    "alertText2": "at least 6 months from arrival date"
                },
                "birthDay": {
                    "regex": "none",
                ...
                "arrivalDate": {
                    "regex": "none",
                    "alertText": "* Arrival date could not be a past ",
                    "alertText2": " date"
                },
                "exitDateFloor": {
                    "regex": "none",
                    "alertText": "* Exit date must go after arrival ",
                    "alertText2": " date"
                },
                "exitDateCeiling": {
                    "regex": "none",
                    "alertText": "* Exit date is out of limit range ",
                    "alertText2": "  Please choose again"
                },
                "dateTimeRange": {
                    "regex": "none",
                    "alertText": "* Invalid ",
                ...
                "phone": {
                    ...
                    "regex": /^([\+][0-9]{3}[ \.\-])?([\(]{1}[0-9]{2,6}[\)])?([0-9 \.\-\/]{3,20})((x|ext|extension)[ ]?[0-9]{1,4})?$/,
                ...
                "onlyLetterNumber": {
                    "regex": /^[0-9a-zA-Z]+$/,
                    "alertText": "* Passport number must be only number and letter"
                },
