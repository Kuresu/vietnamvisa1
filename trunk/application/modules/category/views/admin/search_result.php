	    ...
	    <div class="toppage">
	    	<span class="left">
	            ...
	            <input onclick="$('[name=action]').val($('#action').val()); $('#cate_form').submit()" value="Apply" class="btn" type="button">
	       		<input type="text" name="search" onfocus="if (this.value == 'Search...') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Search...';}"  value="<?php if(isset($keyword)){echo $keyword;}else{echo "Search...";}?>" style="width:165px; padding:3px;" />
	        ...
	        <?php if(count($search_list[0])>0){?>
		        ...
		        <div class="linecate2">
		            ...
		            <div id="row_<?php echo $v->id;?>">
			            ...
			            <?php if($v->status == 'yes'){?>
			            	<a href="javascript:void(0);" onclick="category_status('<?php echo $v->id;?>', 'no', '<?php echo $current_url;?>')"><img src="<?php echo base_url();?>public/admin/img/active.png" title="Active" alt="Yes" class="icon png" /></a>
			            <?php }else{?>	
			            	<a href="javascript:void(0);" onclick="category_status('<?php echo $v->id;?>', 'yes', '<?php echo $current_url;?>')"><img src="<?php echo base_url();?>public/admin/img/pending.png" title="Suspend" alt="No" class="icon png" /></a>
			            <?php }?>
			            </div>
