...
class Fcate_model extends CI_Model{
    ...
    function add_fcate($info = array()){
    	return $this->db->insert($this->table, $info);
    }
    
    
    function edit_fcate($fcate_id, $info = array()){
    ...
    function edit_faqs_match($fcate_id, $info = array()){
    	return $this->db->where('cate_id', $fcate_id)
    					->update($this->table_faqs, $info);
    }
    ...
    function delete_many_faqs($cate_id){
    	return $this->db->where_in('cate_id', $cate_id)
    					->delete($this->table_faqs);
    }
